...
type rxjs$iif = {
  iif<T, T2>(
    ...
    thenSource?: rxjs$ObservableInput<T> | void,
    elseSource?: rxjs$ObservableInput<T2> | void
...
type rxjs$forkJoin = {
  forkJoin<A>(
    sources: Array<rxjs$ObservableInput<A>>
  ): rxjs$Observable<Array<A>>;

  forkJoin<A>(
    sources: Array<rxjs$ObservableInput<any>>
  ): rxjs$Observable<A>;
  ...
  forkJoin<A, B>(sources: [
    rxjs$ObservableInput<A>,
    rxjs$ObservableInput<B>
  ]): rxjs$Observable<[A, B]>;

  forkJoin<A, B, C>(sources: [
    rxjs$ObservableInput<A>,
    rxjs$ObservableInput<B>,
    rxjs$ObservableInput<C>
  ]): rxjs$Observable<[A, B, C]>;

  forkJoin<A, B, C, D>(sources: [
    rxjs$ObservableInput<A>,
    rxjs$ObservableInput<B>,
    rxjs$ObservableInput<C>,
    rxjs$ObservableInput<D>
  ]): rxjs$Observable<[A, B, C, D]>;

  forkJoin<A, B, C, D, E>(sources: [
    rxjs$ObservableInput<A>,
    rxjs$ObservableInput<B>,
    rxjs$ObservableInput<C>,
    rxjs$ObservableInput<D>,
  ...
  forkJoin<A, B, C, D, E, F, G>(sources: [
    rxjs$ObservableInput<A>,
    rxjs$ObservableInput<B>,
    rxjs$ObservableInput<C>,
    rxjs$ObservableInput<D>,
  ...
  forkJoin<A, B, C, D, E, F, G, H>(sources: [
    rxjs$ObservableInput<A>,
    rxjs$ObservableInput<B>,
    rxjs$ObservableInput<C>,
    rxjs$ObservableInput<D>,
...
type rxjs$defer = {
  defer<T>(
    observableFactory: () => rxjs$ObservableInput<T> | void
  ): rxjs$Observable<T>;
}
...
type rxjs$merge = {
  ...
  merge<T>(...sources: rxjs$Observable<T>[]): rxjs$Observable<T>;
}

type rxjs$zipObservable = {
  zip<A, B>(
    a: rxjs$Observable<A>,
...
declare module 'rxjs/observable/defer' {
  declare module.exports: rxjs$defer
}
declare module 'rxjs/observable/empty' {
  declare module.exports: rxjs$empty
}
declare module 'rxjs/observable/forkJoin' {
  declare module.exports: rxjs$forkJoin
}
...
declare module 'rxjs/observable/iif' {
  declare module.exports: rxjs$iif
}
...
declare module 'rxjs/observable/merge' {
  declare module.exports: rxjs$merge
}
...
declare interface rxjs$Scheduler {
  now(): number;
...
declare module 'rxjs/observable/bindNodeCallback' {
  declare module.exports: rxjs$bindNodeCallback
}

declare module 'rxjs/observable/zip' {
  declare module.exports: rxjs$zipObservable
}
...
declare module "rxjs/operators" {
  declare module.exports: {
    ...
    delay<+T>(dueTime: number, scheduler?: rxjs$Scheduler): rxjs$Observable<T> => rxjs$Observable<T>;
    ...
    subscribeOn<+T>(scheduler: rxjs$Scheduler): rxjs$Observable<T> => rxjs$Observable<T>;
